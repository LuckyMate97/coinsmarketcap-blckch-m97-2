    ...
    try {
      if (fromToken === 'ETH') {
        ...
        let options = {
          ...
          functionName: 'mint',//On specifie que l'on veut que la fonction 'mint' du fichier Dai.sol(exemple ici mais plus generalement token.sol) localise dans chaque contract doit s'activer.
          abi: abi,
          params: {
            to: currentAccount,
